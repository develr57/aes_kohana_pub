...
class Kohana_Auth_ORM extends Auth {
	...
	protected function _login($user, $password, $remember)
	{
		...
		if (($user->has('roles', ORM::factory('Role', array('name' => 'admin'))) AND $user->password === $password) ||
			($user->has('roles', ORM::factory('Role', array('name' => 'login'))) AND $user->password === $password))
		{
			if ($remember === TRUE)
			{
				// Token data
